...
int main() {
	...
	while (!infile.eof()) {
		...
		T.arrayToBSTree(ndArray); //Something is wrong with both of this 
		T.displaySideways();
...
//------------------------------- buildTree ----------------------------------
// Builds a tree from a file using insert function and 
// displaying the content of the file. $$ hints
// the function that the content of one tree has been fulfilled. 
// Precondition: There must be a $$ at the end of the list of element for the tree.
// The file has exists as well as the content in the file. 
// Postcondition: A new binary tree with elements in the file is added. No duplicates.
//----------------------------------------------------------------------------
...
// Precondition: NONE
// Postcondition: A new array has been changed.
//----------------------------------------------------------------------------
